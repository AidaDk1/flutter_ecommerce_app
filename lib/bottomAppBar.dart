...
class _BottomBarState extends State<BottomBar> {
  ...
  final tabs = [
    ...
    Center(child: PrimaryText(text: 'Profile Page', size: 40, color: AppColors.purple)),
    Center(child: PrimaryText(text: 'Cart detail Page', size: 40, color: AppColors.purple2)),
  ];
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: currentIndex == 0 ? AppColors.primaryLight : AppColors.purple2,
